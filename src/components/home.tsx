    ...
    return (
        <div className='text-white'>
            <Parallax pages={5} style={{ backgroundColor: 'black' }}>
                ...
                <ParallaxLayer offset={0} speed={0} factor={2} style={{ backgroundImage: `url(${stars})`, backgroundRepeat: 'repeat', opacity: 0.5 }}>
                </ParallaxLayer>

                <animated.div style={starProps}>
                    <ParallaxLayer offset={0} speed={0.25} factor={1.5} style={{ backgroundImage: `url(${stars})`, backgroundRepeat: 'repeat', opacity: 1, transform: 'rotate(90deg)' }}>
                    </ParallaxLayer>
                </animated.div>
                    ...
                    <div className='text-white flex-col ml-32 mr-32 bg-black'>
                        <div className='flex items-end justify-between mb-5'>
                            ...
                            <div className='flex justify-around w-2/5 italic'>
                                ...
                                <a onClick={() => blogRef.current?.scrollIntoView({ behavior: 'smooth' })}>Blog</a>
                            </div>
                ...
                <ParallaxLayer offset={2}>
                    <div ref={aboutRef} className='ml-32'>
                        <p>
                            Christopher Berry is an independent developer with a passion for the mitigation of suffering
                        </p>
                    </div>
                </ParallaxLayer>
